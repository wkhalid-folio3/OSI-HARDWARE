...
var BaseTypeDAL = (function () {
     ...
     */
    BaseTypeDAL.prototype.getJsonArray = function (records) {
        var result = [];
     ...
     */
    BaseTypeDAL.prototype.getJsonObject = function (row, cols, columnNames) {
        var obj = null;
        if (row) {
     ...
     * @returns {object} json representation of record
     */
    BaseTypeDAL.prototype.getJsonForFullRecord = function (record) {
        var result = null;
        if (!!record) {
     ...
     * @returns {object} json representation of record
     */
    BaseTypeDAL.prototype.getSublistItems = function (record, key) {
        var sublistItems = [];
     ...
     * @returns {void}
     */
    BaseTypeDAL.prototype.upsertLineItems = function (dbRecord, itemData, removeExistingLineItems) {
